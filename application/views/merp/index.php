						...
						<table class="data-table table stripe hover nowrap">
							...
							<tbody>
							    <?php 
            			      	...
            			      	<?php if($user['role_id'] == 10 && $user['unit'] == $r['202006X125X2916'] || $user['role_id'] == 1){ ?>
            			      	<tr>
            			      		<td><?= ++$number; ?></td>
            			      		<td><?= $r['unit']; ?></td>
			...
			<form id="formModalAction" action="" method="post">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group">
							...
							<!--<table class="table stripe hover"><thead><tr><th class="table-plus datatable-nosort">No.</th><th width="50%">Jawaban</th><th>Tindak Lanjut / Evidence</th><th>Rencana Pelaksanaan</th><th>PIC</th></tr>-->
							<!--	<?php for ($i=1; $i < 27; $i++) { ?>-->
                ...
                <div class="modal-footer">
                    <a href="<?= base_url(); ?>merp" type="button" class="btn btn-secondary" required="">Close</a>
...
<script>
	...
	$(document).ready(function(){
		...
		$('.tampilModalUbah').on('click', function(){
			...
			$('#formModalAction').attr('action', url + 'merp');
			$.ajax({
