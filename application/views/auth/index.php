        ...
        <div class="card-body md">
          <div class="container-fluid">
            <div class="text-center">
              <h1 class="h4 text-gray-900 mb-3"><img src="<?= base_url(); ?>assets/deskapp/src/images/pertamina.png"></h1>
              <h2 class="h5 text-gray-900 mb-3">Medical Emergency Response Plan GAP Tools</h2>
            </div>
            ...
            <div class="p-3">
              <form class="user" action="" method="post">
                <div class="form-group">
                  <input type="text" class="form-control" id="inputEmail" name="inputEmail" placeholder="Enter Email Address..." value="<?= set_value('inputEmail'); ?>">
